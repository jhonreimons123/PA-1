<?php
    ...
    $sql = "SELECT * FROM penerima_beasiswa WHERE id = '$id'";
    $result = "SELECT * FROM donations_result WHERE id = '$id'";
    $query = mysqli_query($conn,$sql);
    $data = mysqli_query($conn,$result);
    $donations = mysqli_fetch_assoc($data); 
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
  ...
  <main id="main">
    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2><?php echo $donations['nama']; ?></h2>
          <ol>
            <li><a href="index.html">Donaitons</a></li>
            <li>Detail</li>
          </ol>
        </div>
    ...
    <section class="Detail">
      ...
      <div class="container"><a href=""><p>Lampiran</p></a></div>
    </section>
